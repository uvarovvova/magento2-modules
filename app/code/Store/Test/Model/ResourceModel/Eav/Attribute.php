...
namespace Store\Test\Model\ResourceModel\Eav;
...
class Attribute extends EavAttribute implements ScopedAttributeInterface
{
     ...
     * @var string
     */
    protected $_eventPrefix = PixelSetup::ENTITY_TYPE_CODE . '_entity_attribute';
    ...
    {
        $this->_init('Store\Test\Model\ResourceModel\Attribute');
    }
