...
namespace Store\Test\Model\ResourceModel;

use Magento\Eav\Model\Entity\AbstractEntity;
use Magento\Eav\Model\Entity\Context;
use Magento\Store\Model\Store;
use Magento\Store\Model\StoreManagerInterface;
use Store\Test\Setup\PixelSetup;

class Pixel extends AbstractEntity
{
    /**
     * Store id
     *
    ...
    public function __construct(
        ...
        $this->setType(PixelSetup::ENTITY_TYPE_CODE);
        $this->setConnection(PixelSetup::ENTITY_TYPE_CODE . '_read', PixelSetup::ENTITY_TYPE_CODE . '_write');
        $this->_storeManager = $storeManager;
    }

    /**
     * Retrieve Pixel entity default attributes
     *
     * @return string[]
     */
