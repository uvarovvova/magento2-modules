...
use Store\Test\Setup\EavTablesSetupFactory;
...
class InstallSchema implements InstallSchemaInterface
{
    ...
    public function install(SchemaSetupInterface $setup, ModuleContextInterface $context) //@codingStandardsIgnoreLine
    {
        ...
        $tableName = PixelSetup::ENTITY_TYPE_CODE . '_entity';
        /**
         * Create entity Table
         */
        ...
        /** @var \Store\Test\Setup\EavTablesSetup $eavTablesSetup */
        $eavTablesSetup = $this->eavTablesSetupFactory->create(['setup' => $setup]);
        $eavTablesSetup->createEavTables(PixelSetup::ENTITY_TYPE_CODE);
